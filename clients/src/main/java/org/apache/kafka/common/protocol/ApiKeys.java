...
public enum ApiKeys {
    ...
    CREATE_DELEGATION_TOKEN(21, "CreateDelegationToken");
    //RENEW_DELEGATION_TOKEN_REQUEST(23, "RenewDelegationTokenRequest"),
    //EXPIRE_DELEGATION_TOKEN_REQUEST(24, "ExpireDelegationTokenRequest");
